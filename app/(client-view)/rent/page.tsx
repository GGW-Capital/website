...
export const metadata: Metadata = {
  title: "Rent Properties | Luxury Real Estate",
...
export default async function RentPage({
  ...
  console.log("Fetching rental properties with filters:", JSON.stringify(filterParams, null, 2));
  const propertiesData = await getAllProperties(filterParams);
  
  console.log("Rental properties data received:", 
    propertiesData ? `${propertiesData.length} properties found` : "No properties found");
  ...
  console.log("Processed rental properties count:", processedProperties.length);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h1 className="text-4xl font-serif md:text-5xl font-bold mb-6 text-white">
              Properties for <GradientTitle element="span">Rent</GradientTitle>
            </h1>
            <div className="w-24 h-1 bg-[#D4AF37]/60 mx-auto mb-6"></div>
            <p className="text-lg text-white/80">
              Discover our exclusive collection of luxury rental properties in the UAE
            </p>
          </div>
            ...
            {filteredProperties.length === 0 ? (
              <div className="text-center py-20 bg-[#0a0a0a] border border-[#D4AF37]/20 rounded-xl max-w-4xl mx-auto">
                ...
                <p className="text-white/70 mb-8">
                  We couldn't find any rental properties matching your criteria. Try adjusting your filters.
                </p>
                <Button>
                  <a href="/rent">
                    Reset All Filters
