...
export default async function ProjectDetailsPage({ params }: { params: { id: string } }) {
  ...
  const formattedPrice = project.price ? formatCurrency(project.price) : "Price on Request"
  const formattedArea = project.area ? `${project.area.toLocaleString()} sq.ft` : "Area not specified"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-6">
            <div className="flex items-center text-sm text-white/60">
              ...
              <Link href="/projects" className="hover:text-ggw-gold transition-colors">
                Projects
              </Link>
              <span className="mx-2">/</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold font-serif mb-2 text-white">{project.name}</h1>
              <div className="flex items-center text-[#D4AF37] mb-2">
                <MapPin className="h-4 w-4 mr-1" />
                <span className="text-lg">{project.location}</span>
              </div>
              <div className="flex flex-wrap items-center gap-2">
                <Badge className="bg-[#D4AF37] text-black font-medium">Off-Plan</Badge>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              {project.completionDate && (
                <div className="bg-[#0a0a0a] p-4 rounded-xl border border-[#D4AF37]/10">
                  ...
                  <div className="text-lg font-semibold">{project.completionDate}</div>
                </div>
              )}
            </div>
          </div>
          ...
          {/* Description */}
          <div className="mt-8">
            <h2 className="text-2xl font-bold font-serif mb-6">About This Project</h2>
          ...
          {project.features && project.features.length > 0 && (
            <div className="mt-12">
              <h2 className="text-2xl font-bold font-serif mb-6">Features & Amenities</h2>
          ...
          {project.developer && (
            <div className="mt-12">
              ...
              <div className="bg-[#0a0a0a] p-6 rounded-xl border border-[#D4AF37]/10 flex items-center">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">{project.developer}</h3>
                </div>
              </div>
            </div>
          )}
          ...
          {project.properties && project.properties.length > 0 && (
            <div className="mt-12">
              <h2 className="text-2xl font-bold font-serif mb-6">Properties in This Project</h2>
                      ...
                      <div className="relative h-48">
                        ...
                        <div className="absolute top-4 left-4">
                          <Badge className="bg-[#D4AF37] text-black font-medium">
                            {property.marketType === 'off-plan' ? 'Off-Plan' : property.marketType === 'buy' ? 'For Sale' : 'For Rent'}
                          </Badge>
                        </div>
                      </div>
                      <div className="p-4">
          ...
          <div className="mt-16 py-10 px-8 bg-gradient-to-r from-[#0a0a0a] to-[#121212] rounded-xl border border-[#D4AF37]/20 text-center">
            ...
            <p className="text-white/70 mb-8 max-w-2xl mx-auto">
              Contact our team of luxury real estate experts to learn more about this exclusive project and explore available units.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href={`https://wa.me/+971568663666?text=I'm interested in ${project.name} project`} target="_blank">
